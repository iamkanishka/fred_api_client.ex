defmodule FredApiClient.Tags do
  ...
  @doc """
  Get all tags, or search/filter tags.
  ...
  def get_tags(params \\ %{}, config), do: Client.get("/fred/tags", params, config)
  ...
  def get_related_tags(params, config), do: Client.get("/fred/related_tags", params, config)
